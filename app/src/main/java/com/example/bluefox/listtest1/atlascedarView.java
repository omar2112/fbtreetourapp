 ...
 */
public class atlascedarView extends View {
    ...
    public atlascedarView(Context context) {
        super(context);
        init(null, 0);
    }

    public atlascedarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public atlascedarView(Context context, AttributeSet attrs, int defStyle) {
