 ...
 */
public class hybridhollyView extends View {
    ...
    public hybridhollyView(Context context) {
        super(context);
        init(null, 0);
    }

    public hybridhollyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public hybridhollyView(Context context, AttributeSet attrs, int defStyle) {
