 ...
 */
public class evergreenmagnoliasView extends View {
    ...
    public evergreenmagnoliasView(Context context) {
        super(context);
        init(null, 0);
    }

    public evergreenmagnoliasView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public evergreenmagnoliasView(Context context, AttributeSet attrs, int defStyle) {
