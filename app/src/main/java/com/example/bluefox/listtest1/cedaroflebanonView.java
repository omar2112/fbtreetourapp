 ...
 */
public class cedaroflebanonView extends View {
    ...
    public cedaroflebanonView(Context context) {
        super(context);
        init(null, 0);
    }

    public cedaroflebanonView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public cedaroflebanonView(Context context, AttributeSet attrs, int defStyle) {
