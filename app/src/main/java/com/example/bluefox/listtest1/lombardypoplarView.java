 ...
 */
public class lombardypoplarView extends View {
    ...
    public lombardypoplarView(Context context) {
        super(context);
        init(null, 0);
    }

    public lombardypoplarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public lombardypoplarView(Context context, AttributeSet attrs, int defStyle) {
