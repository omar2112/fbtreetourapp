 ...
 */
public class hybridplanetreessycamoreView extends View {
    ...
    public hybridplanetreessycamoreView(Context context) {
        super(context);
        init(null, 0);
    }

    public hybridplanetreessycamoreView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public hybridplanetreessycamoreView(Context context, AttributeSet attrs, int defStyle) {
