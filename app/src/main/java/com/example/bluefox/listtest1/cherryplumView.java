 ...
 */
public class cherryplumView extends View {
    ...
    public cherryplumView(Context context) {
        super(context);
        init(null, 0);
    }

    public cherryplumView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public cherryplumView(Context context, AttributeSet attrs, int defStyle) {
