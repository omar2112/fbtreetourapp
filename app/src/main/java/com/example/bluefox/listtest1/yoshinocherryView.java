 ...
 */
public class yoshinocherryView extends View {
    ...
    public yoshinocherryView(Context context) {
        super(context);
        init(null, 0);
    }

    public yoshinocherryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public yoshinocherryView(Context context, AttributeSet attrs, int defStyle) {
