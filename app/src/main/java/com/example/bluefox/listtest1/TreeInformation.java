    ...
    private void setInformation(final String itemValue) {
        ...
        switch(itemValue) {
            ...
            case ("Lombardy Poplar"):
                ...
                description.setText("Across the street from the Architecture Building on the corner of Stevens Way and Grant Place is a large Lombardy poplar. This is a towering columnar tree whose burly trunk dates from the 1909 Alaska-Yukon-Exposition. Since the tree is readily reproduced by suckers, it has become a common, well known tree in many parts of the world. It originated as a chance mutation in Lombardy, Italy in the late 1600s or early 1700s. Western Washington suits it better than about anywhere else in the United States, so we have many old, landmark specimens.\n" +
                        "\n" +
