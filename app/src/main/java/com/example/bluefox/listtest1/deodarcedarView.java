 ...
 */
public class deodarcedarView extends View {
    ...
    public deodarcedarView(Context context) {
        super(context);
        init(null, 0);
    }

    public deodarcedarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public deodarcedarView(Context context, AttributeSet attrs, int defStyle) {
