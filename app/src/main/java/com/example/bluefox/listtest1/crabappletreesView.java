 ...
 */
public class crabappletreesView extends View {
    ...
    public crabappletreesView(Context context) {
        super(context);
        init(null, 0);
    }

    public crabappletreesView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public crabappletreesView(Context context, AttributeSet attrs, int defStyle) {
